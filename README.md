...
技术交流Q群:524592021<通常没人说话>

还不如直接联系作者本人Q: 80258153
...
[凡事您成功的使用本框架、并且在技术论坛、或者公开网站、发布本项目有价值项目、博客、推广教程等、均可用联系我获取完全免费授权]
...
更多案例：直接参考源码的case包里面案例;<非付费用户，只能测试useragent 部分效果> 如需授权 联系作者
